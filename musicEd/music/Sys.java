...
public class Sys extends Mass {
    ...
    public Sys(Page page, int iSys) {
        ...
        addReaction(new Reaction("E-E"){ // either creates beam or add more beams to beam group
            ...
            public int bid(Gesture gest) {
                ...
                // System.out.println("Intersector list" + temp.size());
                if (temp.size() < 2) {return UC.noBid;}
                Beam b = temp.get(0).beam;
                for(Stem s : temp) {if(s.beam != b) {System.out.println("stems have different beams"); return UC.noBid;}} 
                // System.out.println("all stems same beam " + b);
            ...
            public void act(Gesture gest) {
                System.out.println("stem cross action");
                int x1 = gest.vs.xL(), y1 = gest.vs.yL(), x2 = gest.vs.xH(), y2 = gest.vs.yH();
                Stem.List temp = Sys.this.stems.allIntersectors(x1, y1, x2, y2);
                Beam b = temp.get(0).beam;
                if(b == null) {
                    ...
                    System.out.println("increment list of stems");
